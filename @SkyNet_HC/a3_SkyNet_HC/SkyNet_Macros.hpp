...
#define ADD_DB(DB) switch (DB) do {\
									case 0: {_result = "extDB1" callExtension format["9:ADD_DATABASE_PROTOCOL:%1:sql_custom:%2:skyraw.ini",DATABASE_SELECTION(DB),FETCH_CONST(HC_SQL_ID1)];	}; \
									case 1: {_result = "extDB2" callExtension format["9:ADD_DATABASE_PROTOCOL:%1:sql_custom:%2:skyraw.ini",DATABASE_SELECTION(DB),FETCH_CONST(HC_SQL_ID2)];	}; \
									case 2: {_result = "extDB3" callExtension format["9:ADD_DATABASE_PROTOCOL:%1:sql_custom:%2:custom.ini",DATABASE_SELECTION(DB),FETCH_CONST(HC_SQL_ID3)];	}; \
									}
