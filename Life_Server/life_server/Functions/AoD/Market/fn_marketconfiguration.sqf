...

{
	...
	if(_item isEqualTo "ironr") then {_iron_rPrice = _itemprice}; // The right price should be assigned
	if(_item isEqualTo "diamondc") then {_diamondcPrice = _itemprice}; // The right price should be assigned
	if(_item isEqualTo "copperr") then {_copper_rPrice = _itemprice}; // The right price should be assigned
	if(_item isEqualTo "saltr") then {_salt_rPrice = _itemprice}; // The right price should be assigned
...
life_market_resources_1 = [
	...
	["copperr", _copper_rPrice, 500, 3000, 0.5, 0.5,   
		[ 
//				["ironr", -0.25],
//				["diamondc", 0.5],
//				["copperr",0.5],
...
life_market_resources_2 = [
	...
	["saltr", _salt_rPrice, 1210, 6000, 1, 1,   
		[ 
				["oilp", 0.5]
//				["glass", 0.0],
//				["rabbitfp", 0.5],
...
//				["sig",0.5]
	...
	["ironr", _iron_rPrice, 1475, 4050, 0.5, 0.5,     
		[ 
//				["ironr", 0.5],
				["diamondc",0.5]
//				["copperr",0.25]
