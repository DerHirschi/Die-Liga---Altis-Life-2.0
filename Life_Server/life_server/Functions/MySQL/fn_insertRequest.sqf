...
*/
private["_uid","_name","_money","_bank","_queryResult","_query"];
params [
	"_uid",
	"_name",
	["_money",0],
...
if(typeName _queryResult isEqualTo "STRING") exitWith {[] remoteExecCall ["SOCK_fnc_dataQuery",_returnToSender];}; //There was an entry!
