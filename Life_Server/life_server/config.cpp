...
class CfgFunctions
{
	...
	class TON_System
	{
		...
		class AutoProcess
		{
			file = "\life_server\Scripte\AutoProcess";
			
			class handleVehInv				{};		//TON_fnc_handleVehInv
		};	

		class PlayerGroupSys
		{
			file = "\life_server\Scripte\PlayerGroupSys";
			
			class ManagPlCount				{};		//TON_fnc_ManagPlCount
			class NPCgroupToHC				{};		//TON_fnc_NPCgroupToHC
		};			
		...
		class DB_Act
		{
		file = "\life_server\Scripte\DB";
			
			class cleanOldPlayer 			{};	//TON_fnc_cleanOldPlayer

		};	
		
		class Schiffswrack20
		{
		file = "\life_server\Scripte\Schiffswrack20";
