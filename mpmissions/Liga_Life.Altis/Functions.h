...
class Life_Client_Core
{
	...
	class Scripts
	{
		...
		class switchMove 		{};
		class radartrap 		{};
		class SperzonenSys 		{};			//LIFE_fnc_SperzonenSys
	};	
...
class LigaClient
{
	...
	class Func
	{
		...
		class IgiVehInit		{};		
		class play3DSound		{};		
		class playerSideCount	{};			//LIGACL_fnc_playerSideCount
	};
	...
	class Act
	{
		...
		class ranloot			{};			//LIGACL_fnc_ranloot
		class geknebelt 		{};			//LIGACL_fnc_geknebelt	
	};	
