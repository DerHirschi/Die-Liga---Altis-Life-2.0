...
class CfgRemoteExec {
    class Functions {
		...
		#include "scripts\maverick\maverick_remoteExec_master.cpp"		
    ...
    /* Client only functions  */
		...
		F(life_fnc_stripDownPlayer,CLIENT)   
...
//F(TON_fnc_clientMessage,CLIENT)
   ...
   //     F(life_fnc_freezePlayer,CLIENT)
    ...
    /* Server only functions */					
		...
		F(SKY_fnc_initHouses,SERVER)
		F(SKY_fnc_initLaden,SERVER)
