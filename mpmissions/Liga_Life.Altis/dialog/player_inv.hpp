...
class playerSettings {
	 ...
	 */
     ...
     class ButtonCell: life_RscButtonMenu
     {
		 ...
		 w = 0.028875 * safezoneW;
		 h = 0.0504 * safezoneH;
		 onButtonClick = "[2]spawn liga_fnc_handy; ";
     ...
     class Lotto_ICON: life_RscPicture
     {
		 idc = 1211;
		 text = "images\tablet\Lotto_Kugel.paa";
		 x = ((0.581372 + 0.038061 ) * safezoneW + safezoneX);
		 y = 0.6988 * safezoneH + safezoneY;
		 w = 0.0315 * safezoneW;
		 h = 0.056 * safezoneH;
     };	
	 class Lotto: life_RscButtonMenu
     {
		 idc = 9801;
		 x = ((0.582685 + 0.038062) * safezoneW + safezoneX);
		 y = 0.7016 * safezoneH + safezoneY;
		 w = 0.028875 * safezoneW;
		 h = 0.0504 * safezoneH;
		 onButtonClick = "closeDialog 0;	[player] remoteExec ['TON_fnc_LottoPlInfo',2];";
		 tooltip = "Lotto";
		 colorBackground[] = {-1,-1,-1,-1};
		 colorBackgroundFocused[] = {1,1,1,0.12};
		 colorBackground2[] = {0.75,0.75,0.75,0.2};
     ...
     class Hilfe_ICON: life_RscPicture
     {
		 idc = 1212;
		 text = "images\tablet\book.paa";
		 x = ((0.581372 + (0.038061 * 2) ) * safezoneW + safezoneX);
		 y = 0.6988 * safezoneH + safezoneY;
		 w = 0.0315 * safezoneW;
		 h = 0.056 * safezoneH;
     };	
	 class Hilfe: life_RscButtonMenu
     {
		 idc = 9802;
		 x = ((0.582685 + (0.038062 * 2 ) ) * safezoneW + safezoneX);
		 y = 0.7016 * safezoneH + safezoneY;
		 w = 0.028875 * safezoneW;
		 h = 0.0504 * safezoneH;
     ...
     class Rechner_ICON: life_RscPicture
     {
		 idc = 1213;
		 text = "images\tablet\calc.paa";
		 x = ((0.581372 + (0.038061 * 2) ) * safezoneW + safezoneX);
		 y = 0.6372 * safezoneH + safezoneY;
		 w = 0.0315 * safezoneW;
		 h = 0.056 * safezoneH;
     };	
	 class Rechner: life_RscButtonMenu
     {
		 idc = 9803;
		 x = ((0.582685 + (0.038062 * 2 ) ) * safezoneW + safezoneX);
     ...
     class XP_ICON: life_RscPicture
     {
		 idc = 1213;
		 text = "images\tablet\xp_sys.paa";
		 x = ((0.581372 + 0.038061 ) * safezoneW + safezoneX);
		 y = 0.6372 * safezoneH + safezoneY;
		 w = 0.0315 * safezoneW;
		 h = 0.056 * safezoneH;
     };	
	 class XP: life_RscButtonMenu
     {
		 idc = 9803;
		 x = ((0.582685 + 0.038062) * safezoneW + safezoneX);
		 y = 0.64 * safezoneH + safezoneY;
     ...
     class heliruf_ICON: life_RscPicture
     {
		 idc = 1214;
		 text = "images\tablet\xp_sys.paa";
		 x = 0.581372 * safezoneW + safezoneX;
	 ...
	 class heliruf: life_RscButtonMenu
     {
		 idc = 9804;
		 x = 0.582685 * safezoneW + safezoneX;
		 y = 0.64 * safezoneH + safezoneY;
		 w = 0.028875 * safezoneW;
		 h = 0.0504 * safezoneH;
		 onButtonClick = "closeDialog 0; 0 spawn LIGACL_fnc_rufHeli;";
		 tooltip = "Heli-Taxi rufen";
		 colorBackground[] = {-1,-1,-1,-1};
		 colorBackgroundFocused[] = {1,1,1,0.12};
		 colorBackground2[] = {0.75,0.75,0.75,0.2};
		 color[] = {1,1,1,1};
     ...
     class ALACnot_ICON: life_RscPicture
     {
		 idc = 1215;
		 text = "images\tablet\xp_sys.paa";
		 x = 0.543311 * safezoneW + safezoneX;
	 ...
	 class ALACnot: life_RscButtonMenu
     {
		 idc = 9805;
		 x = 0.544623 * safezoneW + safezoneX;
		 y = 0.64 * safezoneH + safezoneY;
		 w = 0.028875 * safezoneW;
		 h = 0.0504 * safezoneH;
		 onButtonClick = "closeDialog 0; if!((east countSide playableUnits) isEqualTo 0 ) then {hint 'Es sind ALAC Mitglieder im Dienst. Kontaktiere sie.'}else{ 1 spawn LIGACL_fnc_rufHeli; };";
		 tooltip = "ALAC Notdienst rufen";
		 colorBackground[] = {-1,-1,-1,-1};
		 colorBackgroundFocused[] = {1,1,1,0.12};
		 colorBackground2[] = {0.75,0.75,0.75,0.2};
		 color[] = {1,1,1,1};
