...
if(_shop isEqualTo "cop" && playerSide != west) exitWith {hint "Du biste kein Polizist.. Du kannst dich aber gerne mal Bewerben falls du nenn Job suchst...";};
if(_shop isEqualTo "ada" && playerSide isEqualTo civilian) exitWith {hint "Du biste kein ALAC oder LRK Mitarbeiter.. Du kannst dich aber gerne mal Bewerben falls du nenn Job suchst...";};
/*
