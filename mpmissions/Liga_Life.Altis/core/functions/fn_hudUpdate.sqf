...
//#define COUNTEAST [east] call LIGACL_fnc_playerSideCount
//#define COUNTWEST [west] call LIGACL_fnc_playerSideCount
//#define COUNTIND [independent] call LIGACL_fnc_playerSideCount
//#define COUNTCIV [civilian] call LIGACL_fnc_playerSideCount
...
#define COUNTCIV ((civilian countSide playableUnits) + (player countEnemy playableUnits))
