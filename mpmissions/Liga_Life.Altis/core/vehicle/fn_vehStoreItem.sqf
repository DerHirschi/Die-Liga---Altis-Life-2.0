...
if(life_trunk_vehicle isKindOf "House_F" && !( (typeOf life_trunk_vehicle) in ["Land_fs_feed_F","Land_Tank_rust_F","Land_Research_house_V1_F"])) then {	
	_mWeight = 0;
...
_FuelStuffboth 	= ["rib","rip","apple","water","tbacon","peach","coffee","donuts"]; //Beides erlaubt
//_FuelTrucks 	= ["Land_fs_feed_F","Land_Tank_rust_F","C_Van_01_fuel_F","B_Truck_01_fuel_F","Land_Pod_Heli_Transport_04_fuel_F","O_Truck_02_fuel_F","O_Truck_03_fuel_F","O_Heli_Transport_04_fuel_F"]; //Fuel Trucks, who are allowed to carry fuel
