...
if((life_pInact_curTarget GVAR ["house_owned",false])) exitWith {hint "Dieses Geschaeft gehoert bereits jemanden... "};
...
if(_action) then {
	...
	life_pInact_curTarget SVAR ["house_owner",[_uid,profileName],true];
	life_pInact_curTarget SVAR ["ladextra",["Liga Laden",0,0],true];
	life_pInact_curTarget SVAR ["luid",floor(random 99999),true];
	...
	_marker = createMarkerLocal [format["laden_%1",(life_pInact_curTarget GVAR "luid")],getPosATL life_pInact_curTarget];
