...
class Maverick_ConvoySidemission
{
	class Config
	{
		...
		TimeoutBetweenMarkers					= 30000;
		SidesNotAttackable[]					= {"WEST","EAST"};
		AIDifficulty[] = {
												{"aimingAccuracy", 1},
												{"aimingShake", 1},
												{"aimingSpeed", 1},
	...
	class ConvoyConfigurationsPool
	{
		...
		class GoldBarTransport
		{
			...
			class AIUnits
			{
				gear[] = {
												...
												"G_Shades_Blue", // Glasses
												"U_B_GEN_Soldier_F", // Uniform
												"V_TacVest_gen_F", // Vest
												"B_Kitbag_mcamo", // Backpack
												{"arifle_SPAR_01_blk_F", "30Rnd_556x45_Stanag", 5}, // Primary weapon, ammo and how many magazines
												{"arifle_SPAR_01_blk_F", "30Rnd_556x45_Stanag", 5}, // Secondary weapon, ammo and how many magazines
				};
			};
			...
			class Vehicles
			{
				...
				maxSpeed						= 50;
				removeVehiclesAfterSeconds		= 6000;
		...
		class WeaponTransport
		{
			...
			class Vehicles
			{
				...
				maxSpeed						= 50;
				removeVehiclesAfterSeconds		= 60000;
				additionalUnitsAmount			= 6;
			};
