...
*/
    ...
    class civ_car {
        ...
        vehicles[] = {
            ...
            { "C_Van_01_fuel_F", 			225000, { "driver" }, 	{ "", "", -1 } },
    ...
    class civ_truck {
        side = "civ";
        vehicles[] = {
            { "C_Van_01_box_F", 				297000 , { "truck" }, { "", "", -1 } },
            { "I_Truck_02_transport_F", 		492000 , { "truck" }, { "", "", -1 } },
            { "I_Truck_02_covered_F", 			702000 , { "truck" }, { "", "", -1 } },
            { "O_Truck_03_transport_F", 		2048000, { "truck" }, { "", "", -1 } },
            { "O_T_Truck_03_transport_ghex_F", 	2048000, { "truck" }, { "", "", -1 } },
            { "O_T_Truck_03_covered_ghex_F",	2305000, { "truck" }, { "", "", -1 } },
            { "O_Truck_03_covered_F", 			2305000, { "truck" }, { "", "", -1 } },
            { "B_Truck_01_transport_F", 		2633000, { "truck" }, { "", "", -1 } },
            { "B_Truck_01_ammo_F", 				3680000, { "truck" }, { "", "", -1 } },
            { "O_T_Truck_03_ammo_ghex_F", 		6470000, { "truck" }, { "", "", -1 } },
            { "O_Truck_03_ammo_F", 				6470000, { "truck" }, { "", "", -1 } },
            { "O_T_Truck_03_device_ghex_F", 	15852000,{ "truck" }, { "", "", -1 } },
            { "O_Truck_03_device_F", 			15852000,{ "truck" }, { "", "", -1 } },
            { "B_Truck_01_box_F", 				4467000, { "truck" }, { "", "", -1 } },
            { "B_Truck_01_covered_F", 			7368000, { "truck" }, { "", "", -1 } },
            { "O_Truck_02_fuel_F", 				809000 , { "truck" }, { "", "", -1 } },
            { "O_T_Truck_03_fuel_ghex_F", 		1392000, { "truck" }, { "", "", -1 } },
            { "O_Truck_03_fuel_F", 				1392000, { "truck" }, { "", "", -1 } },
            { "B_Truck_01_fuel_F", 				2072000, { "truck" }, { "", "", -1 } },
			
            { "O_Truck_03_repair_F", 			19859435, { "truck" }, { "", "", -1 } },
            { "o_t_truck_03_repair_ghex_f", 	19859435, { "truck" }, { "", "", -1 } }
		};
    };	
    ...
    class civ_ship {
        side = "civ";
        vehicles[] = {
            { "C_Rubberboat", 				10000  , { "boat" }, { "", "", -1 } },
            { "C_Boat_Civil_01_F", 			33000  , { "boat" }, { "", "", -1 } },
            { "O_SDV_01_F", 				1200000, { "boat" }, { "", "", -1 } },        
...
// >>>>>>>>> L1GA - Rebellen <<<<<<<<<<<<	
    class reb_car {
        ...
        vehicles[] = {
            ...
            { "B_G_Offroad_01_armed_F", 		1500000, 	{ "rebel" }, 	{ "", "", -1 } },
    ...
    class reb_air {
        ...
        vehicles[] = {
            ...
            { "I_Heli_Transport_02_F", 			5160000, { "rebel" }, { "", "", -1 } },
...
// <<<<<<<<<<<< L1GA - Polizei >>>>>>>>>>>>>
    ...
    class cop_airhq {
        ...
        vehicles[] = {
            ...
            { "I_Heli_Transport_02_F", 			320000, { "cAir" }, { "life_coplevel", "SCALAR", 6 } },
    ...
    class cop_ship {
        side = "cop";
        vehicles[] = {
            { "B_Boat_Transport_01_F", 			3000 ,  { "boat" }, { "life_coplevel", "SCALAR", 2 } },
            { "C_Boat_Civil_01_police_F", 		20000 , { "boat" }, { "life_coplevel", "SCALAR", 2 } },
			{ "C_Boat_Transport_02_F", 			30000 , { "boat" }, { "life_coplevel", "SCALAR", 2 } },
            { "B_Boat_Armed_01_minigun_F", 		75000 , { "boat" }, { "life_coplevel", "SCALAR", 2 } },
...
*/
	...
	class O_Heli_Transport_04_F { // Taru
        ...
        textures[] = {
            ...
            { "ALAC", "adac", {
                "textures\ADAC\Taru_Adac_T1_00000.jpg",
                "textures\ADAC\Taru_ADAC_T2_00000.jpg"               
            } },
            { "Blau", "civ", {
	...
	class O_Heli_Transport_04_repair_F { //Taru Rep
        ...
        textures[] = {
			{ "ALAC", "adac", {
                "textures\ADAC\Taru_Adac_T1_00000.jpg",
                "textures\ADAC\Taru_ADAC_T2_00000.jpg",              
				"textures\ADAC\Taru_Adac_T3_00000.jpg",
	...
	class I_MRAP_03_F { //Strider
        ...
        textures[] = {
            ...
            { "Polizei", "cop", {
                "textures\Strider\strider_sek.jpg"
            } }			
		};
		ligatexture1[] = {};
        ligatexture2[] = {};
	...
	class B_Heli_Light_01_F { //Humingbird MH-9
        ...
        textures[] = {
            ...
            { "Polizei", "cop", {
                "textures\Humm\police_hummingbird.jpg"
            } }			
		};
		ligatexture1[] = {};
        ligatexture2[] = {};
