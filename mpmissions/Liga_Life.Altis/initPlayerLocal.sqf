...
if(!hasInterface) exitWith {"BIS_fnc_MP_packet" addPublicVariableEventHandler {}; diag_log "NO INTERFACE !!!";};//This is a headless client, he doesn't need to do anything but keep being headless..
"BIS_fnc_MP_packet" addPublicVariableEventHandler {_this call life_fnc_MPexec};

setTerrainGrid 45;
setViewDistance 1200;
setObjectViewDistance [1200,50];
